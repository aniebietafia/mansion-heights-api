...
// };
const convertFeaturesToArray = (...featuresInput) => {
  const result = featuresInput.map((feature) => {
    return feature.substring(0, 1).toUpperCase() + feature.substring(1).toLowerCase();
  });
  return result;
};
